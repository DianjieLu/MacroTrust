...
szBuffer1 = './dataTchange_W0.5/sin_fraction_node_change_zeta4.txt'; 
...
szBuffer1 = './dataTchange_W0.5/sin_fraction_node_change_zeta6.txt'; 
f1=fopen(szBuffer1,'r');
i=1;
while 1
nextline = fgetl(f1);
...
szBuffer1 = './dataTchange_W0.5/sin_fraction_node_change_zeta8.txt'; 
f1=fopen(szBuffer1,'r');
i=1;
while 1
nextline = fgetl(f1);
...
%%networks, zeta = 4
szBuffer1 = './dataTchange_W0.5/sin_average_fraction_zeta4.txt'; 
f1=fopen(szBuffer1,'r');
i=1;
while 1
nextline = fgetl(f1);
...
%%Read the f_{TIGC} values statistically collected from simulation
%%networks, zeta = 6
szBuffer1 = './dataTchange_W0.5/sin_average_fraction_zeta6.txt'; 
f1=fopen(szBuffer1,'r');
i=1;
while 1
nextline = fgetl(f1);
...
%%Read the f_{TIGC} values statistically collected from simulation
%%networks, zeta = 8
szBuffer1 = './dataTchange_W0.5/sin_average_fraction_zeta8.txt'; 
f1=fopen(szBuffer1,'r');
i=1;
while 1
nextline = fgetl(f1);
