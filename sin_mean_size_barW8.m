%Verify the results when bar_W = 0.8, and T varies from 0 to 1
bar_W = 0.8;
T = 0:0.01:1.0;
steps = 101;
...
%%networks, zeta = 4
szBuffer1 = './dataTchange_W0.8/average_sin_cluster_size_zeta4.txt'; 
f1=fopen(szBuffer1);
i=1;
while 1
nextline = fgetl(f1);
...
%%Read sin and sout values statistically collected from simulation
%%networks, zeta = 6
szBuffer1 = './dataTchange_W0.8/average_sin_cluster_size_zeta6.txt'; 
f1=fopen(szBuffer1);
i=1;
while 1
nextline = fgetl(f1);
...
%%Read sin and sout values statistically collected from simulation
%%networks, zeta = 8
szBuffer1 = './dataTchange_W0.8/average_sin_cluster_size_zeta8.txt'; 
f1=fopen(szBuffer1);
i=1;
while 1
nextline = fgetl(f1);
...
hold on; 
sHandle = scatter(w_s6,meansize6,70,'s','filled');
